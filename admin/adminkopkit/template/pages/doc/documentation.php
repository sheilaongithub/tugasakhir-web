        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <?php
					  include "../../../../koneksi.php";
                      $no=1;
                      $ambildata = mysqli_query($koneksi,"select * from tb_kafe");
                      while($tampil = mysqli_fetch_array($ambildata)){
						//ketika tidak ada gambar atau file pada database berupa -
						if (empty($tampil['gambar']) or ($tampil['gambar'] == '-')) {
                      ...
                      <tr>
					  <td></td>
                      <td>$tampil[nama_kafe]</td>
                      <td>$tampil[deskripsi]</td>
                      <td><img src='../images/$gambar' width=70px height=90px></td>
                      <td><a href='?kode=$tampil[nama_kafe]'> Hapus </a></td>
                      <tr>";
                      $no++;
                      }
                ?>
                ...
                <?php
                    ...
                    if(isset($_GET['kode'])){
                    	mysqli_query($koneksi,"delete  from tb_kafe where nama_kafe='$_GET[kode]'");
                    }
                ?>
            </table>
        </div>
				...
				<form action="upload.php" method="post" enctype="multipart/form-data">
					...
					<div class="modal-body">					
						<div class="form-group">
							...
							<input type="hidden" class="form-control" name="id_kafe" id="id_kafe" required>
							<input type="text" class="form-control" name="nama_kafe" id="nama_kafe" required>
						</div>
						<div class="form-group">
					...
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" name="batal" value="batal">
			...
			<div class="modal-content">
				<form>
					...
					<div class="modal-body">					
						...
						<p class="text-warning"><small>jika iya tekan tombol ya</small></p>
					</div>
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
