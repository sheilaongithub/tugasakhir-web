        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tabel manage tesimoni</h4>
                   <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                      ...
                      include "../../../../koneksi.php";
                      $no=1;
                      $ambildata = mysqli_query($koneksi,"select * from tb_testimoni");
                      while($tampil = mysqli_fetch_array($ambildata)){
                      echo "
                      <tr>
                      <td>$tampil[id_testimoni]</td>
                      <td>$tampil[isi_testimoni]</td>
                      <td><a href='?kode=$tampil[id_testimoni]'> Hapus </a></td>
                      <tr>";
                      $no++;
                      }
                      ?>
                    ...
                    if(isset($_GET['kode'])){
                    mysqli_query($koneksi,"delete  from tb_testimoni where id_user='$_GET[kode]'");
                    }
                    ?>
