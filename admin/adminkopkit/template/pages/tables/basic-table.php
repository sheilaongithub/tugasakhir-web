        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tabel manage kategori</h4>
                  <a href="plus_kategori.php">tambah data</a>
                   <div class="table-responsive pt-3">
                    ...
                    if(isset($_GET['kode'])){
                    mysqli_query($koneksi,"delete  from tb_kategori where id_kategori='$_GET[kode]'");
                    }
                    ?>
